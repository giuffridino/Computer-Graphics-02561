window.onload = function init()
{
    ...
    function displayScoringPlayer(hud, player)
    {
        ...
        if (winnerPlayer == 1) {
            ...
            hud.font = `30px "Verdana"`; 
            hud.fillStyle = 'Green';
            hud.fillText("PLAYER 2 WINS!!!", 256, 385);
        }
        else if (player == 1) {
            hud.font = `30px "Verdana"`; 
            hud.fillStyle = 'Green';
    ...
    function drawFinalRect()
    {
        ...
        let rectColors = [ vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0),
                          vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0)];
        gl.bindBuffer(gl.ARRAY_BUFFER, cBuffer);
    ...
    const spikeY = 1;
    const spikeY2 = -1;
    var spikeColors = [vec4(1.0, 0.0, 0.0, 1.0)];
    ...
    function drawSpikes()
    {
        ...
        index += 6 * (i);
        numPoints += 6 * (i);
        spikeColors = [vec4(1.0, 0.0, 0.0, 1.0)];
    }
    ...
    function drawBars()
    {
        ...
        let barColors = [ vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0),
                          vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0), vec4(1, 1, 1, 1.0)];
        gl.bindBuffer(gl.ARRAY_BUFFER, cBuffer);
    ...
    function getReflectDirection(normal, HitBar)
    {
        ...
        // let rand_dir = vec2(Math.random() / 2, Math.random() / 2);
