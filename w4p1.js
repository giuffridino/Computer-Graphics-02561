window.onload = function init()
{
    ...
    // gl.vBuffer = null;
    // var numVerts = initSphere(gl, Subdivis);
    // function initSphere(gl, Subdivis)
    // {
    ...
    function render()
    {
        ...
        // gl.drawElements(gl.TRIANGLES, pointsArray.length, gl.UNSIGNED_INT, 0);
        console.log("drawing arrays", pointsArray.length);
