    window.onload = function init()
{
    ...
    // var shadow_matrix = mat4();
    // var SLoc = gl.getUniformLocation(program, "shadow_matrix");
    // gl.uniformMatrix4fv(SLoc, false, flatten(shadow_matrix));
    ...
    const radius = 2.0;
    var alpha = 0;
    var LLoc = gl.getUniformLocation(program, "LightPos");
    ...
    function render()
    {
        ...
        gl.uniform4fv(LLoc, flatten(light_pos));
